...
![Colocalisation Marker Count Validation](images/CD68_val.png)

### GLUT1 - Region of Interest

![Region of Interest Count Validation](images/GLUT1_val-01.png)

### Iba1 - Reference Marker

![Reference Marker Count Validation](images/Iba1_Val-01.png){alt="Reference Marker Count Validation"}

### Amyloid-beta - Region of Interest

![Region of Interest Count Validation](images/Ab_val-01.png)
