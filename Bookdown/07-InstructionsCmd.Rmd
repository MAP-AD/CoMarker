...
1.  Download the github repo and save the folder on your device. [Find the CoMarker Github page here](https://github.com/MAP-AD/CoMarker). The main folder must include the 'Bash', 'Functions' and 'HTML Reports' folders.
